...
Source:		ftp://ftp.perl.org/pub/CPAN/modules/by-module/Authen/TacacsPlus-%{version}.tar.gz
...
strip --strip-unneeded $RPM_BUILD_ROOT/%{perl_sitearch}/auto/Authen/TacacsPlus/*.so
